...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product item1 = new Product("Cloak of Levitation","E-616CLK110",29.74);
        item1.SetQuantity(3);
        order1.AddToCart(item1);
        Product item2 = new Product("Sling Ring","E-616RNG000",39.99);
        item1.SetQuantity(1);
        order1.AddToCart(item2);
        Product item3 = new Product("Eye of Agamotto","E-616AML032",9.60);
        item1.SetQuantity(3);
        ...
        item1 = new Product("16.5cm Atraumatic Vascular Clamps","CLMPAT165",1.00);
        item1.SetQuantity(24);
        order2.AddToCart(item1);
        item2 = new Product("125mm Cardiovascular Clamp","CLMPC125",55.54);
        item2.SetQuantity(6);
        order2.AddToCart(item2);
        item3 = new Product("14cm Angled Cardio Multi-purpose Clamp","CLMPMP140A",385.11);
        item3.SetQuantity(3);
